...
private class DataManager: DefaultCellDataManager {
    init() {
        super.init(initialItems: [
            .titleNextVC(title: "UserDefaults", viewController: CSUserDefaultsPage())
        ])
    }
}


class CSDataSaveListVC: UIViewController {
...
// MARK: - TableView 代理方法
extension CSDataSaveListVC: UITableViewDelegate, UITableViewDataSource {
    // 行高
