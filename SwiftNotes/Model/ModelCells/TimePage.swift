...
class TimePage: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getTimeStr.set(superview: view, text: getTimeStrWithTimeStamp(timeInterval: 1463637807, dateFormat: "yyyy/M/d HH:mm:ss"))
        getTimeStr.setStyle17pt222()
        getTimeStr.setFrame(left: 20, top: 20)
        
        let getTimeStamp = UILabel()
        getTimeStamp.set(superview: view, text: getTimeStampWithTimeStr(timeStr: "2018/2/2 10:10:11", dateFormat: "yyyy/M/d HH:mm:ss"))
