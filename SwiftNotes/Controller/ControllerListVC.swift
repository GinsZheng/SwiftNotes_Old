...
class CSControllerListVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let titleList = ["Test", "ActionSheet", "Alert", "Class", "Custom Popup Window", "Decorator", "Delegate", "Delegate2", "For & While", "Gesture", "Jump", "Loading", "Menu Controller", "Number Formatter", "Plist", "Protocol", "Reload Data", "Timer", "Try"]
    let pageList = [TestVC(), CSActionSheetPage(), CSAlertListPage(), CSClassPage(), CSCustomPopupWindowPage(), CSDecoratorPage(), CSDelegatePage(), CSDelegate2Page(), CSForWhilePage(), CSGestureListPage(),  CSJumpListPage(), CSLoadingPage(), CSMenuControllerPage(), CSNumberFormatterPage(), CSPlistPage(), CSProtocolPage(), CSReloadDataPage(), CSTimerPage(), CSTryPage()]
